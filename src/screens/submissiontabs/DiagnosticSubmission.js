...
import { getUserDefaultDetails, SaveDiagnosticReport } from '../../api/api';
...
const DiagnosticSubmission = ({ route }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const res = await SaveDiagnosticReport(patientData);
            if (!res) {
    ...
    const renderEmptyState = () => (
        <View style={styles.emptyStateContainer}>
            ...
            <Text style={styles.emptyStateSubtitle}>
                Tap the scan button below to start scanning diagnostic reports
            </Text>
        </View>
    );
