...
import { getPatientDetails, getpatientprofiledetail, getUserDefaultDetails, SavePrescriptionReport } from '../../api/api';
...
const PrescriptionSubmission = ({ route }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const resdoc = await getpatientprofiledetail(Patient.uhid);
    ...
    const renderEmptyState = () => (
        <View style={styles.emptyStateContainer}>
            ...
            <Text style={styles.emptyStateSubtitle}>
                Tap the scan button below to start scanning prescriptions
            </Text>
        </View>
    );
